...
export declare const text: {
    ...
    readonly title1: "ock-font-family font-semibold text-2xl leading-9";
...
export declare const pressable: {
    ...
    readonly alternate: "cursor-pointer ock-bg-alternate active:bg-[var(--ock-bg-alternate-active)] hover:bg-[var(--ock-bg-alternate-hover)]";
