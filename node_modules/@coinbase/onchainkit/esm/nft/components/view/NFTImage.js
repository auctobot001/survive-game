...
function NFTImage({
  ...
  return /*#__PURE__*/jsxs("div", {
    className: cn('grid aspect-square w-full', '[&>*]:col-start-1 [&>*]:col-end-1 [&>*]:row-start-1 [&>*]:row-end-1', className),
    children: [/*#__PURE__*/jsx("div", {
      className: "flex items-center justify-center",
      children: defaultNFTSvg
    }), /*#__PURE__*/jsx("div", {
      className: cn('grid h-full w-full content-center justify-center overflow-hidden', {
      ...
      children: /*#__PURE__*/jsx("img", {
        ...
        alt: description,
        decoding: "async",
        className: cn('transition-opacity duration-500 ease-in-out', loaded ? 'opacity-100' : 'opacity-0', {
