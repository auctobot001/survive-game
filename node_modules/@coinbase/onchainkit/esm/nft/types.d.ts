 ...
 */
export type UseNFTData = (contractAddress: Hex, // Contract address of the NFT
 ...
 * Note: exported as public Type
 */
export type BuildMintTransaction = (props: BuildMintTransactionDataProps) => Promise<Call[]>;
