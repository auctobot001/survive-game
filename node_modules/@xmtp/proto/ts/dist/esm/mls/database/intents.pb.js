...
export const UpdatePermissionData_V1 = {
    ...
    create(base) {
        return UpdatePermissionData_V1.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUpdatePermissionData_V1();
...
export const PostCommitAction = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.sendWelcomes !== undefined) {
            obj.sendWelcomes = PostCommitAction_SendWelcomes.toJSON(message.sendWelcomes);
        }
        return obj;
    },
    create(base) {
        return PostCommitAction.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePostCommitAction();
...
export const PostCommitAction_Installation = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.welcomePointeeEncryptionAeadTypes !== undefined) {
            WelcomePointeeEncryptionAeadTypesExtension.encode(message.welcomePointeeEncryptionAeadTypes, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    message.welcomePointeeEncryptionAeadTypes = WelcomePointeeEncryptionAeadTypesExtension.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            welcomeWrapperAlgorithm: isSet(object.welcomeWrapperAlgorithm)
                ? welcomeWrapperAlgorithmFromJSON(object.welcomeWrapperAlgorithm)
                : 0,
            welcomePointeeEncryptionAeadTypes: isSet(object.welcomePointeeEncryptionAeadTypes)
                ? WelcomePointeeEncryptionAeadTypesExtension.fromJSON(object.welcomePointeeEncryptionAeadTypes)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.welcomeWrapperAlgorithm !== 0) {
            obj.welcomeWrapperAlgorithm = welcomeWrapperAlgorithmToJSON(message.welcomeWrapperAlgorithm);
        }
        if (message.welcomePointeeEncryptionAeadTypes !== undefined) {
            obj.welcomePointeeEncryptionAeadTypes = WelcomePointeeEncryptionAeadTypesExtension.toJSON(message.welcomePointeeEncryptionAeadTypes);
        }
        return obj;
    },
    create(base) {
        return PostCommitAction_Installation.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePostCommitAction_Installation();
        ...
        message.welcomePointeeEncryptionAeadTypes =
            (object.welcomePointeeEncryptionAeadTypes !== undefined && object.welcomePointeeEncryptionAeadTypes !== null)
                ? WelcomePointeeEncryptionAeadTypesExtension.fromPartial(object.welcomePointeeEncryptionAeadTypes)
                : undefined;
        return message;
    },
};
...
export const PostCommitAction_SendWelcomes = {
    ...
    toJSON(message) {
        ...
        if (message.installations?.length) {
            obj.installations = message.installations.map((e) => PostCommitAction_Installation.toJSON(e));
        }
        if (message.welcomeMessage.length !== 0) {
    ...
    create(base) {
        return PostCommitAction_SendWelcomes.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePostCommitAction_SendWelcomes();
        message.installations = object.installations?.map((e) => PostCommitAction_Installation.fromPartial(e)) || [];
