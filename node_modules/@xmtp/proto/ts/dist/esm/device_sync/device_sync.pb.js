...
export const BackupElement = {
    ...
    fromJSON(object) {
        return {
            ...
            groupMessage: isSet(object.groupMessage) ? GroupMessageSave.fromJSON(object.groupMessage) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.group !== undefined) {
            obj.group = GroupSave.toJSON(message.group);
        }
        if (message.groupMessage !== undefined) {
            obj.groupMessage = GroupMessageSave.toJSON(message.groupMessage);
        }
        if (message.consent !== undefined) {
            obj.consent = ConsentSave.toJSON(message.consent);
        }
        if (message.event !== undefined) {
            obj.event = EventSave.toJSON(message.event);
        }
        return obj;
    },
    create(base) {
        return BackupElement.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseBackupElement();
...
function createBaseBackupMetadataSave() {
    return { elements: [], exportedAtNs: Long.ZERO, startNs: undefined, endNs: undefined };
}
export const BackupMetadataSave = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        writer.ldelim();
        if (!message.exportedAtNs.equals(Long.ZERO)) {
    ...
    fromJSON(object) {
        return {
            elements: globalThis.Array.isArray(object?.elements)
                ...
                : [],
            exportedAtNs: isSet(object.exportedAtNs) ? Long.fromValue(object.exportedAtNs) : Long.ZERO,
            startNs: isSet(object.startNs) ? Long.fromValue(object.startNs) : undefined,
    ...
    create(base) {
        return BackupMetadataSave.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseBackupMetadataSave();
        ...
        message.startNs = (object.startNs !== undefined && object.startNs !== null)
            ...
            : undefined;
        message.endNs = (object.endNs !== undefined && object.endNs !== null) ? Long.fromValue(object.endNs) : undefined;
        return message;
    },
};
...
export const BackupOptions = {
    ...
    create(base) {
        return BackupOptions.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseBackupOptions();
        message.elements = object.elements?.map((e) => e) || [];
