...
exports.GroupMessageSave = exports.ContentTypeSave = exports.DeliveryStatusSave = exports.GroupMessageKindSave = exports.protobufPackage = void 0;
...
})(GroupMessageKindSave || (exports.GroupMessageKindSave = GroupMessageKindSave = {}));
...
})(DeliveryStatusSave || (exports.DeliveryStatusSave = DeliveryStatusSave = {}));
...
})(ContentTypeSave || (exports.ContentTypeSave = ContentTypeSave = {}));
...
exports.GroupMessageSave = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (!message.sentAtNs.equals(long_1.default.ZERO)) {
    ...
    fromJSON(object) {
        return {
            ...
            decryptedMessageBytes: isSet(object.decryptedMessageBytes)
                ...
                : new Uint8Array(0),
            sentAtNs: isSet(object.sentAtNs) ? long_1.default.fromValue(object.sentAtNs) : long_1.default.ZERO,
            ...
            sequenceId: isSet(object.sequenceId) ? long_1.default.fromValue(object.sequenceId) : undefined,
            originatorId: isSet(object.originatorId) ? long_1.default.fromValue(object.originatorId) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.sequenceId !== undefined) {
            obj.sequenceId = (message.sequenceId || long_1.default.ZERO).toString();
        }
        if (message.originatorId !== undefined) {
            obj.originatorId = (message.originatorId || long_1.default.ZERO).toString();
        }
        return obj;
    },
    create(base) {
        return exports.GroupMessageSave.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGroupMessageSave();
