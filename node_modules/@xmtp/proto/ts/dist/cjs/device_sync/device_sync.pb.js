...
exports.BackupOptions = exports.BackupMetadataSave = exports.BackupElement = exports.BackupElementSelection = exports.protobufPackage = void 0;
...
})(BackupElementSelection || (exports.BackupElementSelection = BackupElementSelection = {}));
...
function createBaseBackupElement() {
    return { metadata: undefined, group: undefined, groupMessage: undefined, consent: undefined, event: undefined };
}
exports.BackupElement = {
    ...
    fromJSON(object) {
        return {
            metadata: isSet(object.metadata) ? exports.BackupMetadataSave.fromJSON(object.metadata) : undefined,
            group: isSet(object.group) ? group_backup_pb_1.GroupSave.fromJSON(object.group) : undefined,
            groupMessage: isSet(object.groupMessage) ? message_backup_pb_1.GroupMessageSave.fromJSON(object.groupMessage) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        if (message.metadata !== undefined) {
            obj.metadata = exports.BackupMetadataSave.toJSON(message.metadata);
        }
        if (message.group !== undefined) {
            obj.group = group_backup_pb_1.GroupSave.toJSON(message.group);
        }
        if (message.groupMessage !== undefined) {
            obj.groupMessage = message_backup_pb_1.GroupMessageSave.toJSON(message.groupMessage);
        }
        if (message.consent !== undefined) {
            obj.consent = consent_backup_pb_1.ConsentSave.toJSON(message.consent);
        }
        if (message.event !== undefined) {
            obj.event = event_backup_pb_1.EventSave.toJSON(message.event);
        }
        return obj;
    },
    create(base) {
        return exports.BackupElement.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseBackupElement();
...
function createBaseBackupMetadataSave() {
    return { elements: [], exportedAtNs: long_1.default.ZERO, startNs: undefined, endNs: undefined };
}
exports.BackupMetadataSave = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        writer.ldelim();
        if (!message.exportedAtNs.equals(long_1.default.ZERO)) {
    ...
    fromJSON(object) {
        return {
            elements: globalThis.Array.isArray(object?.elements)
                ...
                : [],
            exportedAtNs: isSet(object.exportedAtNs) ? long_1.default.fromValue(object.exportedAtNs) : long_1.default.ZERO,
            startNs: isSet(object.startNs) ? long_1.default.fromValue(object.startNs) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.startNs !== undefined) {
            obj.startNs = (message.startNs || long_1.default.ZERO).toString();
        }
        if (message.endNs !== undefined) {
            obj.endNs = (message.endNs || long_1.default.ZERO).toString();
        }
        return obj;
    },
    create(base) {
        return exports.BackupMetadataSave.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseBackupMetadataSave();
        message.elements = object.elements?.map((e) => e) || [];
        message.exportedAtNs = (object.exportedAtNs !== undefined && object.exportedAtNs !== null)
        ...
        message.startNs = (object.startNs !== undefined && object.startNs !== null)
            ...
            : undefined;
        message.endNs = (object.endNs !== undefined && object.endNs !== null) ? long_1.default.fromValue(object.endNs) : undefined;
        return message;
    },
};
...
exports.BackupOptions = {
    ...
    create(base) {
        return exports.BackupOptions.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseBackupOptions();
        message.elements = object.elements?.map((e) => e) || [];
